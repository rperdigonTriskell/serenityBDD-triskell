...
##    And click in Automation Testing Project sidebar "Project"
##    Then check to "Project" has loaded
#
#  @PROD
#  Scenario: delete project
...
#      | Check | FAV | ATT | NAME                       | PROJECT TYPE | DESCRIPTION | HEALTH  | WORKFLOW   | START DATE | FINISH DATE | TREND  | DELAY  | %COMPLETED | DURATION | DURATION UNIT | SCORE | TECH | RISK | EST. WORK | ACT. WORK | PROJECT MANAGER |
#      |       |     |     | Automation Testing Project |              |             | Correct | Initiation |            | 26/09/2024  | Stable | 0 days | 0 %        | 0        |               | 0     | None | None | 0 hours   | 0 Hours   |                 |
#    Then wait for loading
