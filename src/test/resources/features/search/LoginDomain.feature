...
#  #basic scenarios
  ...
  Scenario Outline: XSS Injection
    ...
    Examples:
      | webside                                                                            |
      | https://intaws.triskellsoftware.com/triskell/init/domain/<script>alert('XSS')</script> |
      | https://intdev.triskellsoftware.com/triskell/init/domain/<script>alert('XSS')</script> |
      | https://intnr.triskellsoftware.com/triskell/init/domain/<script>alert('XSS')</script>  |
      | https://ondemand.triskellsoftware.com/triskell/init/domain/<script>alert('XSS')</script> |
